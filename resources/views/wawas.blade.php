...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
         ...
         <div class="cont_img animate__animated animate__bounce">
            <img src="img/carousel/bannerWawas.png" class="responsive" alt="Responsive image">
            <!--<div class="text_cent_img animated zoomIn"><h1 class="tit-sob-img" style="font-size:2.5em">WAWAS AL CINE</h1></div>-->
            <div class="text_cent_img2 animated zoomIn"><p class="tit-sob-img2"></p></div>
        </div>

        <div class="container">
             <br>
            <h1 class="titulo2   animate__animated animate__fadeInRight animate__delay-1.5s">{{$count}}  Películas Participantes</h1>
            <hr>
