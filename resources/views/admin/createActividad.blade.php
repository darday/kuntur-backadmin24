...
<div class="container">
    <div class="row">
        ...
        <div class="col-12 col-sm-12 col-md-10 col-lg-9 col-xl-9">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('cre_activity') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <input id="name" type="time" class="form-control @error('name') is-invalid @enderror" name="hora" value="" required autocomplete="name" autofocus>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-12">
                            <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="descripcion" value="" required autocomplete="name" autofocus>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-12">
                            <textarea name="lugar" id="textarea" rows="2" class="form-control" required></textarea>
                        </div>
                    </div>
